package com.example.gd12_pdf_c_10850
...
import com.example.gd12_pdf_c_10850.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String){
        ...
        val file = File(pdfPath, "pdf_10850.pdf")
        ...
        @SuppressLint("useCompatLoadingForDrawables") val d = getDrawable(R.drawable.vonny_felicia)
